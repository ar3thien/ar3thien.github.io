...
---
<br>
I'd like to have the whole installation process written as an ansible playbook. Therefore, I will build a template whenever there is a new Omada release. However due to my limited time, I won't be able to do it at the moment. It might be a future project. Stay tuned.
